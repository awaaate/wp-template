  ...
  & { category?: Maybe<(
    ...
    & { posts?: Maybe<(
      ...
      & { edges?: Maybe<Array<Maybe<(
        ...
        & { node?: Maybe<(
          { __typename?: 'Post' }
          & Pick<Post, 'id' | 'slug' | 'title' | 'excerpt'>
          & { featuredImage?: Maybe<(
            { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge' }
            & { node?: Maybe<(
              { __typename?: 'MediaItem' }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Categories(variables?: CategoriesQueryVariables): Promise<CategoriesQuery> {
      return withWrapper(() => client.request<CategoriesQuery>(print(CategoriesDocument), variables));
    },
    CategoryById(variables: CategoryByIdQueryVariables): Promise<CategoryByIdQuery> {
      return withWrapper(() => client.request<CategoryByIdQuery>(print(CategoryByIdDocument), variables));
    },
    PostBySlug(variables: PostBySlugQueryVariables): Promise<PostBySlugQuery> {
      return withWrapper(() => client.request<PostBySlugQuery>(print(PostBySlugDocument), variables));
    },
    ...
    PostsWithSlug(variables?: PostsWithSlugQueryVariables): Promise<PostsWithSlugQuery> {
      return withWrapper(() => client.request<PostsWithSlugQuery>(print(PostsWithSlugDocument), variables));
    }
  };
}
