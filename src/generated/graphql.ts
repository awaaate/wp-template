...
import { GraphQLError, Headers } from 'graphql-request/dist/src/types';
...
/** The post type */
export type Post = Node & ContentNode & UniformResourceIdentifiable & DatabaseIdentifier & NodeWithTitle & NodeWithContentEditor & NodeWithAuthor & NodeWithFeaturedImage & NodeWithExcerpt & NodeWithComments & NodeWithTrackbacks & NodeWithRevisions & MenuItemLinkable & {
  __typename?: 'Post';
  /**
...
export enum MediaItemSizeEnum {
  ...
  /** MediaItem with the 400x250-crop size */
  //400X250Crop = '_400X250_CROP'
}
...
/** The page type */
export type Page = Node & ContentNode & UniformResourceIdentifiable & DatabaseIdentifier & NodeWithTitle & NodeWithContentEditor & NodeWithAuthor & NodeWithFeaturedImage & NodeWithComments & NodeWithRevisions & NodeWithPageAttributes & HierarchicalContentNode & MenuItemLinkable & {
  __typename?: 'Page';
  /**
   * Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root).
   * @deprecated 
...
export type PostBySlugQuery = (
  ...
  & { postBy?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'content' | 'excerpt' | 'title' | 'slug'>
    & { featuredImage?: Maybe<(
      { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge' }
      & { node?: Maybe<(
        { __typename?: 'MediaItem' }
      ...
      { __typename?: 'PostTypeSEO' }
      & Pick<PostTypeSeo, 'canonical' | 'metaDesc' | 'title'>
    )> }
  )> }
);
...
export type PostsWithSlugQueryVariables = Exact<{ [key: string]: never; }>;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Categories(variables?: CategoriesQueryVariables): Promise<{ data?: CategoriesQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<CategoriesQuery>(print(CategoriesDocument), variables));
    },
    PostBySlug(variables: PostBySlugQueryVariables): Promise<{ data?: PostBySlugQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<PostBySlugQuery>(print(PostBySlugDocument), variables));
    },
    Posts(variables?: PostsQueryVariables): Promise<{ data?: PostsQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<PostsQuery>(print(PostsDocument), variables));
    },
    PostsWithSlug(variables?: PostsWithSlugQueryVariables): Promise<{ data?: PostsWithSlugQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<PostsWithSlugQuery>(print(PostsWithSlugDocument), variables));
    }
  };
}
