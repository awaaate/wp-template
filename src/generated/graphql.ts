...
export type PostsWithSlugQuery = { __typename?: "RootQuery" } & {
    posts?: Maybe<
        { __typename?: "RootQueryToPostConnection" } & {
            edges?: Maybe<
                Array<
...
export function getSdk(
    ...
    return {
        Categories(
            ...
            return withWrapper(() =>
                client.rawRequest<CategoriesQuery>(
                    print(CategoriesDocument),
                    variables
                )
            );
        },
        CategoryById(
            ...
            data?: CategoryByIdQuery | undefined;
            extensions?: any;
            headers: Headers;
            status: number;
            errors?: GraphQLError[] | undefined;
            ...
            return withWrapper(() =>
                client.rawRequest<CategoryByIdQuery>(
                    print(CategoryByIdDocument),
                    variables
                )
            );
        },
        PostBySlug(
            ...
            data?: PostBySlugQuery | undefined;
            extensions?: any;
            headers: Headers;
            status: number;
            errors?: GraphQLError[] | undefined;
            ...
            return withWrapper(() =>
                client.rawRequest<PostBySlugQuery>(
                    print(PostBySlugDocument),
                    variables
                )
            );
        },
        Posts(
            ...
            return withWrapper(() =>
                client.rawRequest<PostsQuery>(print(PostsDocument), variables)
            );
        },
        PostsWithSlug(
            variables?: PostsWithSlugQueryVariables
        ): Promise<{
            data?: PostsWithSlugQuery | undefined;
            extensions?: any;
            headers: Headers;
            status: number;
            errors?: GraphQLError[] | undefined;
            ...
            return withWrapper(() =>
                client.rawRequest<PostsWithSlugQuery>(
                    print(PostsWithSlugDocument),
                    variables
                )
            );
        },
